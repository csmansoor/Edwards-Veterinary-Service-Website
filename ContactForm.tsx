...
const ContactForm = () => {
  ...
  return (
    <section className="bg-white" id="contact">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-gray-100">
          ...
          <div className="lg:w-3/5 p-8 md:p-12">
            ...
            <form ref={form} onSubmit={sendEmail} className="space-y-4">
              {/* Hidden field: mirrors the name field for the EmailJS template subject {{user_name}} */}
              ...
              <input
                ...
                required
                onChange={(e) => {
                  const hidden = document.getElementById('user_name_hidden') as HTMLInputElement;
          ...
          <div className="lg:w-2/5 bg-[#008000] p-8 md:p-12 text-white flex flex-col justify-between">
            <div className="space-y-10">
              ...
              <div className="flex gap-5">
                <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center shrink-0">≡ƒôì</div>
                <div>
              ...
              <div className="flex gap-5">
                <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center shrink-0">≡ƒô₧</div>
                <div>
              ...
              <div className="flex gap-5">
                <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center shrink-0">Γ£ë∩╕Å</div>
                <div>
              ...
              <div className="flex gap-5">
                <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center shrink-0">≡ƒòÆ</div>
                <div>
      ...
      {/* Map Section */}
      <div className="max-w-[91rem] mx-auto px-4">
        <div className="h-[530px] rounded-2xl overflow-hidden">
          <iframe
