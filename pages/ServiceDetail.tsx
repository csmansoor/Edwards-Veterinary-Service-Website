...
const ServiceDetail: React.FC = () => {
  ...
  return (
    <div className="bg-white">
      ...
      {/* HEADER SECTION  */}
      <section className="bg-[#008000] py-12 md:py-20 text-white text-center">
      ...
      <div className="container mx-auto px-4 py-8 md:py-24 max-w-7xl">
        ...
        <div className="text-center mb-12 md:mb-20">
          <h2 className="text-2xl md:text-5xl font-bold text-[#008000] uppercase mb-4 md:mb-3">
            {service.section1Heading}
          </h2>
          <h3 className="text-lg md:text-3xl font-semibold text-gray-500 mb-6 md:mb-10">
