      ...
      <div className="container mx-auto px-4 mt-16 max-w-6xl">
          ...
          {TESTIMONIALS.map((t) => (
            ...
            >
              ...
              <div className="flex items-center space-x-4 mt-auto pt-6 border-t border-gray-50">
                <div className="w-12 h-12 bg-[#2a7f62]/10 rounded-full flex items-center justify-center text-[#2a7f62] font-bold text-xl">
                  {t.name.charAt(0)}
                </div>
                <div>
        ...
        <div className="mt-20 text-center bg-[#2a7f62]/5 p-12 rounded-3xl border border-[#2a7f62]/10">
          ...
          <a 
            ...
            className="inline-block bg-[#2a7f62] text-white px-8 py-4 rounded-full font-bold hover:bg-black transition shadow-lg uppercase tracking-widest"
          >
