            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col justify-center items-center md:items-end">
                ...
                <div className="bg-white p-4 rounded-xl">
                  ...
                  <img src="https://storage.googleapis.com/static.mira.ai/user_upload/2025-02-14/petdesk-logo.png" alt="PetDesk logo" className="h-12 w-auto grayscale" onError={(e) => { e.currentTarget.src = "https://via.placeholder.com/150x50?text=PetDesk+Logo"; }} />
                </div>
              </div>
            </div>
