...
// @ts-ignore
import contactBannerImg from '../images/Tillsonburg-City-skyview.webp';
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-[400px] md:h-[600px] flex items-center justify-center overflow-hidden">
        {/* Background Layer with Intentional Blur */}
        <div
        ...
        <div className="container mx-auto px-4 text-center relative z-10 text-white">
          <h1 className="text-3xl md:text-6xl font-black uppercase tracking-tight mb-4 drop-shadow-2xl">
            About Edwards Veterinary Services
          </h1>
          <p className="text-lg md:text-2xl text-green-50 font-medium drop-shadow-lg opacity-90">
            Trusted Veterinary Care in Tillsonburg, ON for Over 35 Years
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="mb-16 md:mb-20">
            <h2 className="text-2xl md:text-3xl font-bold text-[#008000] mb-6">Our Story: Built on Compassion and Community</h2>
          ...
          <div className="bg-gray-900 text-white p-6 md:p-12 rounded-3xl shadow-2xl relative overflow-hidden">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Our Commitment to Sustainability</h2>

            <p className="text-gray-300 text-base md:text-lg mb-8 max-w-2xl text-center md:text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                {/* CHANGE: Text color to readable green on dark bg */}
                <p className="font-bold text-green-400">We also reduce waste by using:</p>
                <ul className="space-y-2">
                  <li className="flex items-center space-x-2">
                    {/* CHANGE: Icon color to readable green on dark bg */}
              ...
              <div className="flex flex-col justify-center items-center md:items-end">
                {/* CHANGE: Text color to readable green on dark bg */}
                <p className="text-green-400 font-bold text-xl italic mb-4">Small changes. Big impact — for pets, people, and the planet.</p>
            ...
            {/* CHANGE: Blob color to #008000 */}
            <div className="absolute -right-20 -bottom-20 w-64 h-64 bg-[#008000]/10 rounded-full blur-3xl"></div>
          </div>

          <div className="mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* CHANGE: Buttons bg to #008000, hover to #006400 */}
            <Link to="/team" className="bg-[#008000] text-white p-6 rounded-xl text-center font-bold hover:bg-[#006400] transition shadow-md">Meet Our Team</Link>
            <Link to="/gallery" className="bg-[#008000] text-white p-6 rounded-xl text-center font-bold hover:bg-[#006400] transition shadow-md">Photo Gallery</Link>
            <Link to="/testimonials" className="bg-[#008000] text-white p-6 rounded-xl text-center font-bold hover:bg-[#006400] transition shadow-md">Testimonials</Link>
            <Link to="/careers" className="bg-[#008000] text-white p-6 rounded-xl text-center font-bold hover:bg-[#006400] transition shadow-md">Careers</Link>
          </div>
        </div>
      </section>
    </div>
