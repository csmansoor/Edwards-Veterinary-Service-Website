    ...
    <div className="bg-white">
      ...
      <section className="bg-[#008000] py-20 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          {/* CHANGE: Text to light green/white mix for contrast on green bg */}
          <p className="text-xl text-green-100">Trusted Veterinary Care in Tillsonburg, ON for Over 35 Years</p>
        </div>
      </section>
