...
const Store: React.FC = () => {
  return (
    <div className="bg-white pb-20">
      ...
      <a
        href="https://www.myvetstore.ca/edwardsveterinaryservices"
        target="_blank"
        rel="noopener noreferrer"
        className="relative h-[500px] md:h-[700px] flex items-center justify-center bg-cover bg-center cursor-pointer block group"
        style={{
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-5xl md:text-7xl font-black uppercase tracking-wide drop-shadow-lg group-hover:scale-105 transition-transform duration-300">
            Pet Store
          </h1>
          <p className="text-xl md:text-2xl font-medium mt-4 drop-shadow-md opacity-90 group-hover:opacity-100 transition-opacity">
      ...
      <div className="container mx-auto px-4 py-16 max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mb-20">
          <div className="md:w-1/2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-[#008000] text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-[#006400] transition shadow-lg transform hover:scale-105"
            >
              Shop Now
            </a>
          </div>
        ...
        <div className="bg-[#008000] text-white p-12 rounded-3xl shadow-2xl text-center">
          ...
          <a
            ...
            className="inline-block bg-white text-[#008000] px-10 py-5 rounded-full font-black text-xl hover:bg-gray-100 transition shadow-2xl"
          >
